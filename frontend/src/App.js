            ...
            <div className="container">
              <div className="row h-100">
                <div className="col-lg-7 mx-auto text-center mb-6">
                  <h5 className="fs-3 fs-lg-5 lh-sm mb-3">
                          ...
                          <div className="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                            <div className="card card-span h-100 text-white">
                              ...
                              <div className="card-img-overlay bg-dark-gradient d-flex flex-column-reverse">
                                ...
                                <p className="text-400 fs-1">
                                  Jumper set for Women
                                </p>
                  ...
                  <div className="card card-span text-white h-100">
                    ...
                    <div className="card-body px-xl-5 px-md-3 pt-0 pb-7">
                      ...
                      <p className="text-900 mt-3">
                        Is it possible to assess a person just on the basis of
                        their footwear? Obviously, nobody should criticize, but
                        certainly, shoes say a lot about someone. It matters for
                        the outsiders that we meet every day...
                      </p>
                      <a
                ...
                <div className="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
                  <div className="card card-span text-white h-100">
                    ...
                    <div className="card-body px-xl-5 px-md-3 pt-0 pb-7">
                      ...
                      <h6 className="text-900 mt-3">
                        Rotondwa Johnny .{' '}
                        <span className="fw-normal">Fashion activist </span>
                      </h6>
                      <h3 className="fw-bold text-1000 mt-5 text-truncate">
                        Fashion trend forecast for Summer 2021
                      </h3>
                      <p className="text-900 mt-3">
                        While the fashion industry has had a calm year, this
                        season has seen some beautiful pieces. Over the previous
                        several weeks, commanding coats, and elegant face masks
                        have ruled Fashion Weeks...
                      </p>
                      <a
                        className="btn btn-lg text-900 fs-1 px-0 hvr-icon-forward"
                        href="#!"
                ...
                <div className="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
                  <div className="card card-span text-white h-100">
                    ...
                    <div className="card-body px-xl-5 px-md-3 pt-0 pb-7">
                      ...
                      <h3 className="fw-bold text-1000 mt-5 text-truncate">
                        Spring exclusive collection for Men &amp; Women
                      </h3>
                      <p className="text-900 mt-3">
                        Explore the first real-time photographic fashion
                        magazine NOWFASHION to broadcast exclusive live fashion
                        shows. Some of the most beautiful spring collection i
                        want to share. See the....
                      </p>
                      <a
                        className="btn btn-lg text-900 fs-1 px-0 hvr-icon-forward"
                        href="#!"
              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-lg-auto ms-auto">
                  ...
                  <p className="text-800">
                    ...
                    <span className="text-800">+0000000000</span>
                  </p>
                  <p className="text-800">
                    <svg
                    ...
                    <span className="text-800">therichposts@gmail.com</span>
                  </p>
                </div>
              </div>
